<?php 
	...
	*/
	...
	class adminbansanControlador extends Controlador
	{
		...
		public function creUsuIns()
		{
			...
			$this->_vista->construirVista('adminbansan','crearUsuarioInstitucion');
		}

		public function agreRepor()
		{
			$this->_vista->breadcrumb = $this->breadcrumbVista('Agreagar a Reporte Banco Sangre','Configuración');
			$this->_vista->tituloGeneral = "Agreagar a Reporte Banco Sangre";
			$this->_vista->construirVista('adminbansan','agregarReporteBancoSangre');
		}
